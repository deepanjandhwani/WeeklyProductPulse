"""
phase1_ingestion/filter.py — Review cleaning and filtering for WeeklyProductPulse.

Responsibilities
----------------
* Apply the ≥10-word constraint (architecture C2).
* Enforce the configured lookback date window (architecture C5).
* Normalise raw Play Store dicts into the canonical review schema.
* Return clean records ready for CSV persistence.

Usage (standalone)
------------------
    python -m phase1_ingestion.filter --week 2026-W11
"""
