...
*Document updated 2026-03-24 — v1.8 adds CI→Railway report upload (`POST /api/reports/upload`) so the Vercel dashboard shows reports generated by GitHub Actions; recommends Railway persistent volume for `data/`.*